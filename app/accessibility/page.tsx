		...
		<main className="accessibilityInclusivity">
			<nav className="frameDiv" aria-label="Breadcrumb">
				...
				<div className="homeParent">
					<Image className="arrowDown01Icon" src="/assets/accessicons/arrowright.svg"  width={16} height={16} sizes="100vw" alt="" />
					<div className="featuresWrapper">
			...
			<div className="image20Parent">
				...
				<div className="frameParent2">
					...
					<div className="peopleTakingPartBusinessEvParent">
						...
						<Image className="frameInner" src="/assets/accessimages/bg.png" width={1216} height={621} sizes="100vw" alt="" />
						<Image className="youngAdultWatchingTvShowWIcon" src="/assets/accessimages/work.png" width={572} height={652} sizes="100vw" alt="" />
					</div>
			...
			<div className="frameParent6">
				...
				<div className="frameParent8">
					<div className="frameParent9">
						<div className="frameWrapper3">
							<div className="compassParent">
								<Image className="compassIcon" src="/assets/accessicons/compass.svg" width={50} height={50} sizes="100vw" alt="" />
						...
						<div className="frameWrapper3">
							<div className="compassParent">
								<Image className="compassIcon" src="/assets/accessicons/library.svg" width={50} height={50} sizes="100vw" alt="" />
								<div className="easyNavigationWrapper">
					...
					<div className="frameParent9">
						<div className="frameWrapper3">
							<div className="compassParent">
								<Image className="compassIcon" src="/assets/accessicons/mouse.svg" width={50} height={50} sizes="100vw" alt="" />
								<div className="easyNavigationWrapper">
						...
						<div className="frameWrapper3">
							<div className="compassParent">
								<Image className="compassIcon" src="/assets/accessicons/clipboard.svg" width={50} height={50} sizes="100vw" alt="" />
								<div className="easyNavigationWrapper">
									...
									<div className="formatIconOuter">
										<div className="formatIconInner formatIconGreen">
											<Image
												...
												src="/assets/accessicons/files.svg"
												width={33.97}
												height={33.97}
												sizes="100vw"
								...
								<div className="frameParent16">
									<div className="formatIconOuter">
										<div className="formatIconInner formatIconPurple">
											<Image
												className="formatIconImage"
												src="/assets/accessicons/video.svg"
												width={33.97}
												height={33.97}
												sizes="100vw"
								...
								<div className="frameParent16">
									<div className="formatIconOuter">
										<div className="formatIconInner formatIconOrange">
											<Image
												className="formatIconImage"
												src="/assets/accessicons/image.svg"
												width={33.97}
												height={33.97}
												sizes="100vw"
								...
								<div className="frameParent16">
									<div className="formatIconOuter">
										<div className="formatIconInner formatIconPink">
											<Image
												className="formatIconImage"
												src="/assets/accessicons/headphone.svg"
												width={33.97}
												height={33.97}
												sizes="100vw"
				...
				<div className="frameParent24">
						...
						<div className="frameParent27">
							<div className="inclusiveItem inclusiveItemPink">
								<Image
									...
									src="/assets/accessicons/arrowpink.svg"
									width={32}
									height={32}
									sizes="100vw"
									alt=""
							...
							<div className="inclusiveItem inclusiveItemBlue">
								<Image
									className="inclusiveArrow"
									src="/assets/accessicons/arrowblue.svg"
									width={32}
									height={32}
									sizes="100vw"
									alt=""
							...
							<div className="inclusiveItem inclusiveItemPurple">
								<Image
									className="inclusiveArrow"
									src="/assets/accessicons/arrowpurple.svg"
									width={32}
									height={32}
									sizes="100vw"
									alt=""
					...
					<div className="learningAnalytics">
						<Image
								...
								src="/assets/accessimages/Learning.png"
								width={530}
								height={488}
								sizes="100vw"
							...
							<div className="institutionIconOuter">
								<div className="institutionIconInner institutionIconPink">
									<Image
										...
										src="/assets/accessicons/globe.svg"
										width={33.97}
										height={33.97}
										sizes="100vw"
						...
						<div className="institutionCardContent">
							<div className="institutionIconOuter">
								<div className="institutionIconInner institutionIconPurple">
									<Image
										className="institutionIconImage"
										src="/assets/accessicons/accessibility.svg"
										width={33.97}
										height={33.97}
										sizes="100vw"
						...
						<div className="institutionCardContent">
							<div className="institutionIconOuter">
								<div className="institutionIconInner institutionIconTeal">
									<Image
										className="institutionIconImage"
										src="/assets/accessicons/user.svg"
										width={33.97}
										height={33.97}
										sizes="100vw"
						...
						<div className="institutionCardContent">
							<div className="institutionIconOuter">
								<div className="institutionIconInner institutionIconBlue">
									<Image
										className="institutionIconImage"
										src="/assets/accessicons/student.svg"
										width={33.97}
										height={33.97}
										sizes="100vw"
