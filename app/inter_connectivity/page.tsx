	...
	return (
			...
			<nav className="frameDiv" aria-label="Breadcrumb">
						...
						<div className="homeParent">
							<Image className="arrowDown01Icon" src="/assets/intericons/arrowright.svg" width={16} height={16} sizes="100vw" alt="" />
							<div className="featuresWrapper">
				...
				<div className="frameParent2">
						...
						<div className="ellipseParent">
							...
							<div className="hierarchySquare06Parent">
									<Image className="hierarchySquare06Icon" src="/assets/intericons/hierarchy.svg" width={60} height={60} sizes="100vw" alt="" />
							...
							<Image
							  className="smallHierarchyIcon"
							  src="/assets/intericons/icon.svg"
							  width={15}
							  height={10}
							  alt=""
							  aria-hidden="true"
						...
						<div className="frameParent6">
							<div className="userGroup02Parent">
									<Image className="userGroup02Icon" src="/assets/intericons/user.svg" width={32} height={32} sizes="100vw" alt="" />
									<b className="learners">Learners</b>
							</div>
							<div className="bankParent">
									<Image className="userGroup02Icon" src="/assets/intericons/bank.svg" width={32} height={32} sizes="100vw" alt="" />
									<b className="learners">Educators</b>
							</div>
						</div>
						<div className="frameParent7">
							<div className="userGroup02Parent">
									<Image className="userGroup02Icon" src="/assets/intericons/plug.svg" width={32} height={32} sizes="100vw" alt="" />
									<b className="learners">Systems</b>
							</div>
							<div className="analyticsUpParent">
									<Image className="userGroup02Icon" src="/assets/intericons/analytics.svg" width={32} height={32} sizes="100vw" alt="" />
				...
				<div className="frameParent8">
						<div className="frameParent9">
							...
							<div className="oneConnectedPlatformForModParent">
									<b className="oneConnectedPlatform">One connected platform for modern learning ecosystems<br/></b>
										...
										<div className="frameParent10">
											...
											<Image
												...
												src="/assets/intericons/links.svg"
												width={40}
												height={40}
												alt="Unified learning ecosystem"
											/>
										</div>
											...
											<Image
												className="featureCardIcon"
												src="/assets/intericons/hand.svg"
												width={40}
												height={40}
											...
											<Image
												className="featureCardIcon"
												src="/assets/intericons/reload.svg"
												width={40}
												height={40}
										...
										<Image
											className="featureCardIcon"
											src="/assets/intericons/analytic.svg"
											width={40}
											height={40}
											alt="Centralized data and insights"
										/>
									</div>
												</div>
										</div>
										...
										<div className="frameParent11">
											...
											<span className="whyNeuroLxpText">
												...
												<div className="benefitIconCircle benefitPink">
													<Image
														className="benefitIconImage"
														src="/assets/intericons/monitor.svg"
														width={34}
														height={34}
														alt="One platform for learning activities"
													/>
												</div>
											</div>
												...
												<div className="benefitIconCircle benefitPurple">
													<Image
														className="benefitIconImage"
														src="/assets/intericons/link.svg"
														width={34}
														height={34}
												...
												<div className="benefitIconCircle benefitBlue">
													<Image
														...
														width={34}
														height={34}
														alt="Better collaboration and engagement"
													/>
												</div>
											</div>
												...
												<div className="benefitIconCircle benefitTeal">
													<Image
														...
														width={34}
														height={34}
														alt="Clearer learning performance insights"
													/>
												</div>
											</div>
												...
												<div className="frameParent21">
													<div className="frameWrapper6">
															<div className="rectangleParent3">
																...
																<Image
											className="frameChild26"
											src="/assets/interimages/img1.png"
											width={300}
											height={204}
											sizes="100vw"
											alt="Universities and Higher Education"
										/>
													...
													<div className="frameWrapper6">
															<div className="rectangleParent3">
																<div className="frameChild25" />
																<Image
											className="frameChild28"
											src="/assets/interimages/img2.png"
											width={300}
											height={204}
											sizes="100vw"
											alt="Corporate Training Academies"
										/>
													...
													<div className="frameWrapper6">
															<div className="rectangleParent3">
																...
																<Image
											className="frameChild28"
											src="/assets/interimages/img3.png"
											width={300}
											height={204}
											sizes="100vw"
											alt="Skill Development Centers"
										/>
													...
													<div className="frameWrapper6">
															<div className="rectangleParent3">
																...
																<Image
											className="frameChild28"
											src="/assets/interimages/img4.png"
											width={300}
											height={204}
											sizes="100vw"
											alt="Hybrid and Remote Learning"
										/>
												...
												<div className="frameParent24">
													<div className="frameParent25">
																...
																<div className="frameParent26">
																		<div className="image20Parent">
																			...
																			<div className="connectLearnersAndEducatorsWrapper">
																					<b className="connectLearnersAnd">Connect Learners and  Educators<br/></b>
																						</div>
																						</div>
																						<div className="frameParent27">
																								<div className="image20Wrapper">
															...
															<div className="ecosystemIconCircle ecosystemIconPink">
																<Image
																	className="ecosystemIconImage"
																	src="/assets/intericons/student.svg"
																	width={34}
																	height={34}
															...
															<div className="ecosystemIconCircle ecosystemIconBlue">
																<Image
																	className="ecosystemIconImage"
																	src="/assets/intericons/building.svg"
																	width={34}
																	height={34}
																	alt="Training Ecosystems"
																/>
															</div>
														</div>
															...
															<div className="ecosystemIconCircle ecosystemIconMaroon">
																...
																/>
																						...
																						<div className="ellipseGroup">
																								<Image className="frameChild43" src="/assets/interimages/bg.png" width={1286} height={540} sizes="100vw" alt="" />
